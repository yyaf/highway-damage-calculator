...
var categories = [
  ...
  },
  {
    ...
    name: '示警桩与视线诱导',
    items: [
      { id: 'warn-post-89-1998', name: '钢管反光示警桩', spec: 'Ø89mm 3英寸', unit: '根', price: 300, source: '1998' },
      { id: 'warn-post-89-2020', name: '钢管反光示警桩', spec: 'Ø89mm 3英寸', unit: '根', price: 350, source: '2020' },
      { id: 'warn-post-114-1998', name: '钢管反光示警桩', spec: 'Ø114mm 4英寸', unit: '根', price: 350, source: '1998' },
      { id: 'warn-post-114-2020', name: '钢管反光示警桩', spec: 'Ø114mm 4英寸', unit: '根', price: 600, source: '2020' },
      ...
      { id: 'mile-post-1998', name: '里程碑(水泥砼)', spec: '', unit: '座', price: 280, source: '1998' },
      { id: 'mile-post-2020', name: '里程碑(水泥砼)', spec: '', unit: '座', price: 406, source: '2020' },
      { id: 'mile-sign', name: '里程牌(单柱式)', spec: '', unit: '个', price: 1500, source: '2020' },
      { id: 'sight-guide', name: '视线诱导标', spec: '', unit: '个', price: 850, source: '2020' },
      { id: 'cone-75-ref-1998', name: '锥形交通路标', spec: '高75cm 反光套', unit: '个', price: 140, source: '1998' },
      { id: 'cone-75-ref-2020', name: '锥形交通路标', spec: '高75cm 反光套', unit: '个', price: 90, source: '2020' },
      { id: 'cone-50-ref-1998', name: '锥形交通路标', spec: '高50cm 反光套', unit: '个', price: 105, source: '1998' },
      { id: 'cone-50-ref-2020', name: '锥形交通路标', spec: '高50cm 反光套', unit: '个', price: 80, source: '2020' },
      ...
      { id: 'delineator-concrete-1998', name: '轮廓标', spec: '钢筋砼柱式', unit: '根', price: 100, source: '1998' },
      { id: 'delineator-concrete-2020', name: '轮廓标', spec: '钢筋砼柱式', unit: '根', price: 192, source: '2020' },
      { id: 'delineator-frp-1998', name: '轮廓标', spec: '玻璃钢柱式', unit: '根', price: 200, source: '1998' },
      { id: 'delineator-frp-2020', name: '轮廓标', spec: '玻璃钢柱式', unit: '根', price: 217, source: '2020' },
      { id: 'delineator-attach-1998', name: '轮廓标', spec: '附着式', unit: '块', price: 55, source: '1998' },
      { id: 'delineator-attach-2020', name: '轮廓标', spec: '附着式', unit: '块', price: 60, source: '2020' }
    ]
  },
  {
    id: 'road-marking',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'ac-shoulder-1998', name: '沥青路肩', spec: '', unit: '平方米', price: 100, source: '1998' },
      { id: 'ac-shoulder-2020', name: '沥青路肩', spec: '', unit: '平方米', price: 275, source: '2020' },
      { id: 'cc-shoulder-1998', name: '水泥路肩', spec: '', unit: '平方米', price: 150, source: '1998' },
      { id: 'cc-shoulder-2020', name: '水泥路肩', spec: '', unit: '平方米', price: 314, source: '2020' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'stone-ditch-1998', name: '石砌边沟、截水沟', spec: '', unit: '米', price: 180, source: '1998' },
      { id: 'stone-ditch-2020', name: '石砌边沟、截水沟', spec: '', unit: '立方米', price: 680, source: '2020' },
      { id: 'soil-ditch', name: '土质边沟、截水沟', spec: '', unit: '米', price: 40, source: '1998' },
      { id: 'precast-ditch-1998', name: '预制铺砌混凝土边沟、截水沟', spec: '', unit: '米', price: 200, source: '1998' },
      { id: 'precast-ditch-2020', name: '预制铺砌混凝土边沟、截水沟', spec: '', unit: '立方米', price: 1700, source: '2020' },
      { id: 'rc-cover-1998', name: '钢筋混凝土盖板', spec: '', unit: '平方米', price: 200, source: '1998' },
      { id: 'rc-cover-2020', name: '钢筋混凝土盖板', spec: '', unit: '立方米', price: 2400, source: '2020' },
      { id: 'rc-retain-wall-1998', name: '钢筋混凝土挡土墙', spec: '', unit: '立方米', price: 700, source: '1998' },
      { id: 'rc-retain-wall-2020', name: '钢筋混凝土挡土墙', spec: '', unit: '立方米', price: 2400, source: '2020' },
      { id: 'dry-rubble-wall-1998', name: '干砌片石挡土墙、护面墙', spec: '', unit: '立方米', price: 150, source: '1998' },
      { id: 'dry-rubble-wall-2020', name: '干砌片石挡土墙、护面墙', spec: '', unit: '立方米', price: 400, source: '2020' },
      { id: 'mortar-rubble-wall-1998', name: '浆砌片石挡土墙、护面墙、护脚', spec: '', unit: '立方米', price: 200, source: '1998' },
      { id: 'mortar-rubble-wall-2020', name: '浆砌片石挡土墙、护面墙、护脚', spec: '', unit: '立方米', price: 700, source: '2020' },
      { id: 'soil-slope', name: '土质边坡', spec: '', unit: '立方米', price: 45, source: '2020' },
      { id: 'mortar-slope-1998', name: '浆砌护坡、锥坡', spec: '', unit: '平方米', price: 85, source: '1998' },
      { id: 'mortar-slope-2020', name: '浆砌护坡、锥坡', spec: '', unit: '立方米', price: 700, source: '2020' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'brg-metal-beam-1998', name: '普通金属制梁柱式护栏(桥)', spec: '', unit: '米', price: 450, source: '1998' },
      { id: 'brg-metal-beam-2020', name: '普通金属制梁柱式护栏(桥)', spec: '', unit: '米', price: 891, source: '2020' },
      { id: 'brg-mixed', name: '普通钢筋砼柱、金属混合式护栏(桥)', spec: '', unit: '米', price: 500, source: '1998' },
      { id: 'brg-rc-wall-1998', name: '钢筋砼墙式护栏(桥)', spec: '', unit: '米', price: 480, source: '1998' },
      { id: 'brg-rc-wall-2020', name: '钢筋砼墙式护栏(桥)', spec: '', unit: '米', price: 1604, source: '2020' },
      { id: 'brg-brick-stone-1998', name: '砖石护栏(桥)', spec: '', unit: '平方米', price: 200, source: '1998' },
      { id: 'brg-brick-stone-2020', name: '砖石护栏(桥)', spec: '', unit: '米', price: 459, source: '2020' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'pollute-mud-1998', name: '污染公路（沙、石、泥土、垃圾）', spec: '', unit: '平方米', price: 5, source: '1998' },
      { id: 'pollute-mud-2020', name: '污染公路（沙、石、泥土、垃圾）', spec: '', unit: '平方米', price: 72, source: '2020' },
      { id: 'pollute-oil-cc-1998', name: '油类、酸、碱类化学物质污染水泥路面', spec: '', unit: '平方米', price: 60, source: '1998' },
      { id: 'pollute-oil-cc-2020', name: '油类、酸、碱类化学物质污染水泥路面', spec: '', unit: '平方米', price: 318, source: '2020' },
      { id: 'pollute-oil-ac-1998', name: '油类、酸、碱类化学物质污染沥青路面', spec: '', unit: '平方米', price: 120, source: '1998' },
      { id: 'pollute-oil-ac-2020', name: '油类、酸、碱类化学物质污染沥青路面', spec: '', unit: '平方米', price: 246, source: '2020' },
      ...
      { id: 'pollute-other-1998', name: '其他物质污染路面', spec: '', unit: '平方米', price: 5, source: '1998' },
      { id: 'pollute-other-2020', name: '其他物质污染路面', spec: '', unit: '平方米', price: 72, source: '2020' },
